package in.milind.authenticationapp.config;

import in.milind.authenticationapp.filter.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    //You can use this also because DaoAuthenticationProvider is deprecated from Spring seccurity 6
    /*@Bean
